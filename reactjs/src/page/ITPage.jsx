...
function ITPage({resetPagination}) {
    ...
    //Show fetch data and count statuses
    useEffect(() => {
        ...
        <div className="table">
            ...
            <div className="tableHeader">
                <div className="tableHRow">
                    {['ชื่อผู้ร้องขอ', 'ฝ่าย', 'ประเภทการเปลี่ยนแปลง', 'วันที่ต้องการใช้งาน','ผู้ดำเนินงาน', 'สถานะ', 'ดำเนินการ'].map(header => <div className="tableCell" key={header}>{header}</div>)}
                </div>
            </div>
